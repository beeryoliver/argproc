...
\author{Oliver Beery}
\date{Version 0.0.0\quad 8 November 2025}
...
\begin{function}{\argproc_int:n}
  ...
  Issues an error if \meta{int expr} contains any extra trailing tokens that were not processed by \meta{int expr}.
\end{function}
...
\begin{function}{\argproc_dim:nn,\argproc_dim:n}
  ...
  \end{syntax}
  Argument processor for use in \cs{NewDocumentCommand} and friends.
  Evaluates \meta{dim expr}, appending a default unit of \meta{unit}, and stores the result in \cs{ProcessedArgument}.
  When fully expanded, \meta{unit} must either match a valid unit of measurement or expand to nothing.
  Issues an error if \meta{dim expr} contains any extra trailing tokens that were not processed by \meta{dim expr}, appending a default unit of \meta{unit}.
...
\begin{function}{\argproc_skip:nn,\argproc_skip:n}
  ...
  \end{syntax}
  Argument processor for use in \cs{NewDocumentCommand} and friends.
  Evaluates \meta{skip expr}, appending a default unit of \meta{unit}, and stores the result in \cs{ProcessedArgument}.
  When fully expanded, \meta{unit} must either match a valid unit of measurement or expand to nothing.
  Issues an error if \meta{skip expr} contains any extra trailing tokens that were not processed by \meta{skip expr}, appending a default unit of \meta{unit}.
...
\begin{function}{\argproc_muskip:n}
  ...
  Issues an error if \meta{muskip expr} contains any extra trailing tokens that were not processed by \meta{muskip expr}.
\end{function}
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_int_set_from_user:Nn}, but sets \meta{integer} equal to its current value plus the result of \meta{int expr}.
\end{function}
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_int_set_from_user:Nn}, but sets \meta{integer} equal to its current value minus the result of \meta{int expr}.
\end{function}
...
\begin{function}
  ...
  \end{syntax}
  Sets \meta{dimension} to the value of \meta{dim expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_dim_set_from_user:Nnn}, but sets \meta{dimension} equal to its current value plus the result of \meta{dim expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_dim_set_from_user:Nnn}, but sets \meta{dimension} equal to its current value minus the result of \meta{dim expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Sets \meta{skip} to the value of \meta{skip expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_skip_set_from_user:Nnn}, but sets \meta{skip} equal to its current value plus the result of \meta{skip expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_skip_set_from_user:Nnn}, but sets \meta{skip} equal to its current value minus the result of \meta{skip expr}, appending a default unit of \meta{unit}.
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_muskip_set_from_user:Nn}, but sets \meta{muskip} equal to its current value plus the result of \meta{muskip expr}.
\end{function}
...
\begin{function}
  ...
  \end{syntax}
  Identical to \cs{argproc_muskip_set_from_user:Nn}, but sets \meta{muskip} equal to its current value minus the result of \meta{muskip expr}.
\end{function}
